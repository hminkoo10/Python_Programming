...
print({word: words.count(word) for word in set(words)})    # ✅ {'apple': 3, 'banana': 2, 'cherry': 1}

# 2️⃣ 60점 이상인 경우 합격 설정하기
scores = {"국어": 85, "영어": 50, "수학": 95, "과학": 40, "사회": 72}

print({k: '합격' for k, v in scores.items() if v >= 90})    # ✅ {'국어': '합격', '수학': '합격', '사회': '합격'}

# 3️⃣ 과목 리스트와 점수 리스트로 딕셔너리 만들기
subjects = ["국어", "영어", "수학"]
grades = [90, 80, 100]

print(dict(zip(subjects, grades)))    # ✅ {'국어': 90, '영어': 80, '수학': 100}
