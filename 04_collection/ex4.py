...
print(str(sum(hours[1:6]))+"시간")              # ✅ 15시간


# 2️⃣ 가장 많이 공부한 시간 출력하기
print(str(max(hours))+"시간")                   # ✅ 6시간


# 3️⃣ 가장 많이 공부한 요일 출력하기
print(days[hours.index(max(hours))]+"요일")  # ✅ 토요일
...
# 총 재고 금액 출력
print(f"{sum(price * quantity for _, price, quantity in stocks):,}원")   # ✅ 총액: 21,000원